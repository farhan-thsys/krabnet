...
- [ ] **Phase 1: Core Types and String Interning** - Shared type definitions and bidirectional string-to-u32 interner used by every module
...
|-------|----------------|--------|-----------|
| 1. Core Types and String Interning | 0/TBD | Not started | - |
